...
import com.example.jetpackdemo.databinding.MeFragmentBinding
...
class MeFragment : Fragment() {
    ...
    private val model: MeModel by viewModels {
        TodoViewModelProvider.providerMeModel(requireContext())
    }
    ...
    override fun onCreateView(
        ...
        val binding: MeFragmentBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.me_fragment,
            container,
            false
        )
